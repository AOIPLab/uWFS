...
#sys.path.append(os.path.split(os.path.split(sys.path[0])[0])[0]) # JDR / Shrum - need a solution that works for notebooks and other environmnts, but this works for command line
#sys.path.append(os.path.join(os.path.dirname(__file__), "..","..")) # JDR - works for command line?
sys.path.append(os.path.join(os.getcwd(), "..",".."))
#print(sys.path)
from ciaoPy3 import cameras,simulator
import ciao_config as ccfg
from matplotlib import pyplot as plt
#import numpy as np
from ciaoPy3 import tools
